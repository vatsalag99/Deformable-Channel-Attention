...
class CifarDCABasicBlock(nn.Module):
    def __init__(self, inplanes, planes, stride=1, reduction=16):
        ...
        self.dca = DCALayer(planes, reduction)
        if inplanes != planes:
...
def dca_resnet20(**kwargs):
    ...
    """
    model = CifarDCAResNet(CifarDCABasicBlock, 3, **kwargs)
    return model
...
def dca_resnet32(**kwargs):
    ...
    """
    model = CifarDCAResNet(CifarDCABasicBlock, 5, **kwargs)
    return model
...
def dca_resnet56(**kwargs):
    """Constructs a ResNet-34 model.
    """
    model = CifarDCAResNet(CifarDCABasicBlock, 9, **kwargs)
    return model
